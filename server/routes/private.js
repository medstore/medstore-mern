...
const {getuser, registerstore , addproduct, searchProduct, getsingleproduct,getrandomproducts, additemtocart, getAllCartItem, removeitemfromcart, buyproduct, getorderhistory} = require('../controllers/private');
